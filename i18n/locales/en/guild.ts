export default {
  guild: {
    title: 'Guilds',
    description:
      'ZEC Perps Guilds is a team-based trading competition. Be part of the winning guild and win together!',
    rewardDescription1:
    ...
    joinGuild: {
      cta: 'Join Guild',
      maxCap: 'Max Capacity',
      title: 'Join a guild on ZEC Perps',
      invitationCode: 'Get invitation code on Discord',
      description:
        'Join the guild "{name}" on ZEC Perps to earn a share of the rewards!'
    },
